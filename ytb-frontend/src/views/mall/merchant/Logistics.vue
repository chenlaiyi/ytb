  ...
  <div class="merchant-logistics">
    <el-card shadow="never">
      ...
      >
        ...
        <el-table-column prop="merchant_name" label="商户" min-width="160" />
...
const fetchData = async () => {
  loading.value = true
  try {
    const response = await mallMerchantApi.getLogistics(listQuery)
    if (response.code === 0) {
    ...
    console.error('获取商户商城物流失败:', error)
