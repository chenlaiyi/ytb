    ...
    <div class="page-header">
      <div class="header-content">
        <div class="header-left">
          ...
          <div class="page-info">
            <h1 class="page-title">新生提现</h1>
            <p class="page-description">管理新生支付系统的提现业务</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <el-card class="welcome-card" shadow="hover">
        <div class="welcome-content">
          ...
          <div class="welcome-text">
            <h2>欢迎使用新生提现管理</h2>
            <p>在这里您可以管理新生支付系统的提现申请、审核和处理流程</p>
          </div>
        </div>
      </el-card>
      ...
      <el-card class="development-card" shadow="hover">
        <div class="development-content">
          ...
          <div class="development-text">
            <h3>功能开发中</h3>
            <p>新生提现管理功能正在紧张开发中，敬请期待！</p>
            <div class="development-progress">
              <el-progress :percentage="15" color="#E6A23C" />
              <span class="progress-text">开发进度：15%</span>
            </div>
          </div>
        </div>
      </el-card>
