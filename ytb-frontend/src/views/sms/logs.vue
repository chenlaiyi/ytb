  ...
  methods: {
    ...
    fetchStats() {
      smsApi.getSmsStatsTest().then(response => {
        ...
        // 确保正确处理API返回格式
        if (response.data && response.code === 0 && response.data) {
